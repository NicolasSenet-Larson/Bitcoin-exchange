...
public class Order {
	...
	/**
	 * Constructor for the current buying and selling rates tables.
	 ...
	 * @param toAddress The address I have to send the matched amount to.
	 ...
	 * @param sendStatus The status of the matched order: pending, accepted or cancelled.
	 */
